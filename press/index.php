...
echo '					<li><a href="#factsheet">'. tl('Factsheet') .'</a></li>
						...
						<li><a href="#projects">'. tl('Releases') .'</a></li>
...
echo'							</p> 
						...
						<div class="uk-width-medium-4-6">
							<h2 id="description">'. tl('Short Description') .'</h2>
							<p>'. COMPANY_DESCRIPTION .'</p>
							<h2 id="history">'. tl('Long Description') .'</h2>';
...
echo '							<h2 id="projects">'. tl('Releases') .'</h2>
							<ul>';
